 ...
 * @author atenc
 */
public class BaseDeDatosLoyola extends JFrame implements ActionListener{
    
       private static JTextField tf1, tf2, tf3, tf4, tf5;
    public JLabel label1, label2, label3, label4, label5, label6;
    private JButton btn1, btn2, btn3;
    
        public BaseDeDatosLoyola() {
        setLayout(null);

        label1 = new JLabel("Registre un nuevo estudiante la base de datos");
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource()==btn2 && f==true){
                label1.setText("Se ha registrado un nuevo estudiante");
                insertDB(conect);
            }
            if(f==false){
    ...
    public static void insertDB(Connection con) {
        ...
        try {
            ...
            String carrera = tf5.getText();
            
            String SQL = "INSERT INTO estudiante VALUES (" + cod + ", '" + nombre + "', '" + apellido + "', " + age + ", '" + carrera + "');";
    ...
    public  boolean conectarDB() {
        ...
        BaseDeDatosLoyola f1 = new BaseDeDatosLoyola();
        f1.setVisible(true);
